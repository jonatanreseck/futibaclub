...
CREATE TABLE IF NOT EXISTS `futibaclub`.`groups_user` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_groups_user_users_idx` (`user_id` ASC),
  INDEX `fk_groups_user_groups1_idx` (`group_id` ASC),
...
CREATE TABLE IF NOT EXISTS `futibaclub`.`guessings` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_guessings_games1_idx` (`games_id` ASC),
  INDEX `fk_guessings_groups1_idx` (`groups_id` ASC),
